...
function ScheduleInterview() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                setSuccessMessage(`Interview scheduled successfully. Mail send to ${formData.candidateEmail}!`);
                alert(`Interview scheduled successfully. Mail send to ${formData.candidateEmail}!`);
            } else {
