...
function ScheduleInterview() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        alert(`Interview credentials sent to mailid (${candidateEmail}) of the candidate!`)
        setSuccessMessage(`Interview credentials sent to mailid (${candidateEmail}) of the candidate!`);
      } else {
